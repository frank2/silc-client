/*
 * Autogenerated by get-signals.pl from ../../doc/signals.txt,
 * do not edit.
 */
...
static PERL_SIGNAL_ARGS_REC perl_signal_args[] =
{
    ...
    { "netsplit server new", { "iobject", "Irssi::Irc::Netsplitserver", NULL } },
    { "netsplit server remove", { "iobject", "Irssi::Irc::Netsplitserver", NULL } },
    ...
    { "proxy client connected", { "Irssi::Irc::Client", NULL } },
    { "proxy client disconnected", { "Irssi::Irc::Client", NULL } },
